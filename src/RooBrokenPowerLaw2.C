#include "RooBrokenPowerLaw2.h"
/// Advertise analytical integral over fX
/*Int_t RooBrokenPowerLaw2::getAnalyticalIntegral(RooArgSet& allVars, RooArgSet& analyticVars, const char * rangeName) const
{
...
Double_t RooBrokenPowerLaw2::CalcPLIntegral(double min, double max, double index) const {
...
Double_t RooBrokenPowerLaw2::analyticalIntegral(Int_t code, const char * rangeName) const {
  if(code == 1){
